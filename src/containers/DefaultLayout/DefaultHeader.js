...
import logo from '../../assets/img/brand/shopping-cart.png';
  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <AppNavbarBrand
          full={{ src: logo, width: 89, height: 25, alt: 'Mercadinho Logo' }}
          minimized={{ src: sygnet, width: 30, height: 30, alt: 'Mercadinho Logo' }}
        />
        ...
        <Nav className="ml-auto" navbar>
          ...
          <UncontrolledDropdown nav direction="down">
            <DropdownToggle nav>
              <img src={'../../assets/img/avatars/6.jpg'} style={{marginRight: 20}} className="img-avatar" alt="admin@bootstrapmaster.com" />
            </DropdownToggle>
            <DropdownMenu right>
